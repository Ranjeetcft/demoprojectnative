...
const FreezeModal = ({
  ...
  return (
    <Modal
      ...
      transparent={true}
      visible={isFreeze}
      onRequestClose={() => setIsFreeze(false)}
    >
      <SafeAreaView
        style={{
          flex: 1,
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {item?.status == "Active"
                ? t("Do you really want to Freeze the Room?")
                : t("Do you really want to Unfreeze the Room?")}
            </Text>
          </View>
          ...
          >
            ...
            >
              {item?.status == "Active" ? t("Yes Freeze") : t("Yes Unfreeze")}
            </Text>
          </TouchableOpacity>
