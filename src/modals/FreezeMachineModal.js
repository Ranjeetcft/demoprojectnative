...
const FreezeMachineModal = ({
  isFreezeMachine,
  setIsFreezeMachine,
  freezeUnfreezeMachineAPI,
  machineItem,
}) => {
  ...
  return (
    <Modal
      animationType="slide"
      transparent={true}
      visible={isFreezeMachine}
      onRequestClose={() => setIsFreezeMachine(false)}
    >
      <SafeAreaView
        style={{
          flex: 1,
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {machineItem?.status == "Active"
                ? t("Do you really want to Freeze the Machine?")
                : t("Do you really want to Unfreeze the Machine?")}
            </Text>
          </View>
          ...
          <Image
            ...
            source={require("../asset/icons/freezeIcon.png")}
          ></Image>
...
export default FreezeMachineModal;
