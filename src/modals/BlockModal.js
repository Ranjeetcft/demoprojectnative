        ...
        >
          ...
          >
            ...
            >
              {status == "Active"
                ? blockType == "Worker"
                  ? t("Do you really want to Block the Worker")
                  : t("Do you really want to Block the Manager")
                : blockType == "Worker"
                ? t("Do you really want to Unblock the Worker")
                : t("Do you really want to Unblock the Manager")}
            </Text>
          </View>
          ...
          <Image
            ...
            source={require("../asset/icons/blockIcon.png")}
          ></Image>
          ...
          >
            ...
            >
              {status == "Active" ? t("Yes Block") : t("Yes Unblock")}
            </Text>
          </TouchableOpacity>
